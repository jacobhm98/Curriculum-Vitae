...
\begin{tabularx}{0.97\linewidth}{>{\raggedleft\scshape}p{2cm}X}
\gray Period & \textbf{September 2021 --- 2023 (Estimate)}\\
...
& I have completed the coursework for a specialized degree in Machine Learning. My main interest areas are probabilistical methods and neural networks. In order to develop my professional skills I plan to take a study break.
\end{tabularx}
